...
/* harmony import */ var date_fns__WEBPACK_IMPORTED_MODULE_13__ = __webpack_require__(/*! date-fns */ "./node_modules/date-fns/esm/nextSunday/index.js");
/* harmony import */ var date_fns__WEBPACK_IMPORTED_MODULE_14__ = __webpack_require__(/*! date-fns */ "./node_modules/date-fns/esm/getMonth/index.js");
...
class TodoListElement {
  ...
  static _generateTaskFormFields(form, existingTaskId = null) {
    ...
    if (existingTaskId !== null) {
      ...
      priorityField[1].querySelectorAll('[name="priority"] > option').forEach(elem => {
      ...
      dueDateField[1].value = task.dueDate.toISOString().split("T")[0]
    }
  ...
  static filterTasks(filterName, type) {
    ...
    switch (type) {
      ...
      case "date":
        if (filterName === "today") {
          condition = (elem) => {
            return (elem.dueDate !== "" && (0,date_fns__WEBPACK_IMPORTED_MODULE_10__.default)(elem.dueDate));
          };
          ...
          condition = (elem) => {
            ...
            return ((0,date_fns__WEBPACK_IMPORTED_MODULE_11__.default)((0,date_fns__WEBPACK_IMPORTED_MODULE_12__.default)(today), elem.dueDate) === -1 &&
                (0,date_fns__WEBPACK_IMPORTED_MODULE_11__.default)((0,date_fns__WEBPACK_IMPORTED_MODULE_13__.default)(today), elem.dueDate) === 1)
          };
          ...
          condition = (elem) => {
            ...
            return (0,date_fns__WEBPACK_IMPORTED_MODULE_14__.default)(new Date()) === (0,date_fns__WEBPACK_IMPORTED_MODULE_14__.default)(elem.dueDate);
          };
        }
        break;
      case "category":
...
class TodoListSidebar {
  ...
  #getCategoriesAsLinks() {
    let categories = _TodoListStorage_js__WEBPACK_IMPORTED_MODULE_0__.default.getAllItems().filter(task => task.completed === false);
