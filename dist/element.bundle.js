...
class TodoListSidebar {
  ...
  #getCategoriesAsLinks() {
    ...
    for (let cat in categories) {
      ...
      catLink.addEventListener("click", () => {_TodoListElement_js__WEBPACK_IMPORTED_MODULE_2__.TodoListElement.filterTasks(cat, "category")});
