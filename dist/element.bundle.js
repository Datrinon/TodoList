...
/* harmony import */ var _priority_js__WEBPACK_IMPORTED_MODULE_2__ = __webpack_require__(/*! ./priority.js */ "./src/js/priority.js");
/* harmony import */ var _TodoListConnection_js__WEBPACK_IMPORTED_MODULE_3__ = __webpack_require__(/*! ./TodoListConnection.js */ "./src/js/TodoListConnection.js");





const c = new _component_js__WEBPACK_IMPORTED_MODULE_0__.Component();
...
class TodoListElement {
  ...
  static connection = _TodoListConnection_js__WEBPACK_IMPORTED_MODULE_3__.default;
  constructor() {
  ...
  static _generateTaskFormFields(form, existingTaskId = null) {
    ...
    let p = _priority_js__WEBPACK_IMPORTED_MODULE_2__.default; // calling priority by itself was undefined earlier. 
    ...
    if (existingTaskId !== null) {
      ...
      let task = _TodoListConnection_js__WEBPACK_IMPORTED_MODULE_3__.default.getItemById(existingTaskId);
  ...
  static _handleUpdateTask(taskId) {
    ...
    _TodoListConnection_js__WEBPACK_IMPORTED_MODULE_3__.default.update(task);
    ...
    taskView.querySelector(".task-view-create-date").textContent = (0,date_fns__WEBPACK_IMPORTED_MODULE_4__.default)(task.id, "'Added' MM/dd/yyyy");
  ...
  static _parseFormFields() {
    let task = new _task_js__WEBPACK_IMPORTED_MODULE_1__.Task();
  ...
  static addTaskToView(task, parentSelector) {
    ...
    let createDate = c.paragraph((0,date_fns__WEBPACK_IMPORTED_MODULE_4__.default)(task.id, "'Added' MM/dd/yyyy"), "task-view-create-date"); //c.paragraph();
  ...
  static _deleteTask(e) {
    ...
    const removeTask = (e) => {
      ...
      _TodoListConnection_js__WEBPACK_IMPORTED_MODULE_3__.default.remove(taskId);
